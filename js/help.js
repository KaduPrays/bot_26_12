...
exports.run = (client, message, args) => {
  ...
  **${c.prefix}play** | Link - Nome de uma musica
  **${c.prefix}pause** | Pausar a musica tocando
  **${c.prefix}resume** | Despausar a musica pausada
  **${c.prefix}skip** | Pular a musica atual
  **${c.prefix}stop** | Parar a musica tocando
  **${c.prefix}volume** | Aumentar ou diminuir a musica atual`);
